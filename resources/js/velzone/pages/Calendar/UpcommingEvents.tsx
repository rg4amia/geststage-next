...
day = "0" + day;
  ...
  let e_dt = updatedDay ? updatedDay : undefined;
  ...
  const end_dt = e_dt ? " to " + e_dt : "";
  let e_time_s = tConvert(getTime(props.event.start));
  let e_time_e = tConvert(getTime(updatedDay));
