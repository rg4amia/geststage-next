...
<head>
    ...
    <title>Attestation de présence (C2D)</title>
    <style>
        body {
...
<body>
    <div class="header">
        <table>
            <tr>
                <td style="width: 33%; text-align: center;">
                    <strong>MINISTERE DE LA PROMOTION DE LA JEUNESSE, DE L'INSERTION PROFESSIONNELLE ET DU SERVICE
                        CIVIQUE</strong><br>
                    -------------
                </td>
        ...
        <p style="margin: 0; text-align: center;">
            <strong style="font-size: 20.0pt;">
                ATTESTATION DE {{ $mode_traitement == 2 ? 'DEMARRAGE' : 'PRÉSENCE' }} EN {{ $type_stage }} C2D3
            </strong>
        </p>
    ...
    <div class="footer-section">
        ...
        <div class="signatures">
            <p style="text-align: right; font-size: 11.0pt;">
