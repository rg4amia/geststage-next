...
<body>
    {{-- Header Section --}}
    @include('stage.contrat.partials_pejedec.header', [
        'agence' => $stagiaire->agence,
        'conseiller' => $stagiaire->conseiller->nom_prenoms
    ])

    {{-- Contract Parties Section --}}
    @include('stage.contrat.partials_pejedec.contract-parties', [
        'stagiaire' => $stagiaire,
        'montant' => $montant,
        'fonction' => $fonction,
    ])
    ...
    {{-- Article Pages --}}
    @include('stage.contrat.partials_pejedec.article-pages')

    {{-- Signature Section --}}
    @include('stage.contrat.partials_pejedec.signatures', [
        'stagiaire' => $stagiaire,
        'fonction' => $fonction,
        'agence' => $stagiaire->agence,
    ])
