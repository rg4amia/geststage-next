<div>
    <div style="-aw-headerfooter-type:header-primary; clear:both">
        <p class="Header" style="text-align:center">
            <span>
                <img src="{{ url('contrat-edition/img/head-c2d.png') }}" alt="" width="650" />
            </span>
        </p>
    </div>
    ...
    <div
        ...
        <div style="background-color: #3ea446; border-radius: 25px; padding: 10px 28px; text-align: center; color: white; font-family: Arial, sans-serif; font-weight: bold; border: 2px solid #cb9048;">
            <p style="font-size: 30px; line-height: 1.5; letter-spacing: 0.5px;">PROGRAMME DE STAGE<br> DE QUALIFICATION</p>
