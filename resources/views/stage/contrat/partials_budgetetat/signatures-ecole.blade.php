<div style="page-break-before: always; font-family: 'Cambria', 'Times New Roman', serif; font-size: 11pt; margin: 0 12px;">
    <style>
        .budgetetat-ecole-signature-article {
            width: 100%;
        ...
        .budgetetat-ecole-signature-article td {
            width: 50%;
            vertical-align: top;
            padding: 0 12px;
        }

        .budgetetat-ecole-signature-article h2 {
            font-size: 11.5pt;
            font-weight: 700;
            margin: 8px 0 5px 0;
        ...
        .budgetetat-ecole-signature-article p {
            margin: 3px 0;
            line-height: 1.3;
        }

        .budgetetat-ecole-signature-article .important {
            font-weight: bold;
        }
    </style>
    <table class="budgetetat-ecole-signature-article">
        <tr>
            <td>
