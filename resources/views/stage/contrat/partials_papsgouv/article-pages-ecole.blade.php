@php
    ...
    $dureeKey = (string) $stagiaire->nbre_mois_prev;
    $dureeEnMots = match ($dureeKey) {
        '1' => 'un (1) mois',
        '1.5' => 'un (1) mois quinze (15) jours',
        '2' => 'deux (2) mois',
        '3' => 'trois (3) mois',
...
<style>
    ...
    .papsgouv-ecole-article-table td {
        width: 50%;
        vertical-align: top;
        padding: 0 12px;
        text-align: justify;
    ...
    .papsgouv-ecole-article-table h2 {
        font-size: 11.5pt;
        font-weight: 700;
        margin: 10px 0 6px 0;
    ...
    .papsgouv-ecole-article-table p {
        margin: 4px 0;
    }

    .papsgouv-ecole-article-table ul {
        margin: 8px 0;
        padding-left: 22px;
    }

    .papsgouv-ecole-article-table li {
        margin-bottom: 9px;
    }

    .papsgouv-ecole-article-table .important {
        font-weight: bold;
    }
</style>

<div style="page-break-before: always;">
    <table class="papsgouv-ecole-article-table">
        <tr>
            <td>
                <h2>Article 1 : Nature du contrat</h2>
                <p>Le présent contrat est un <span class="important">contrat de stage de validation</span>.</p>
                ...
                <h2>Article 3 : Obligations de l'USEP</h2>
                <p>L'USEP s'engage à :</p>
                <ul>
            ...
            <td>
                ...
                <ul>
                    ...
                    <li>prévenir l'USEP des <span class="important">fautes graves</span> que le/la stagiaire pourrait commettre ainsi que des absences ou faits de nature à motiver son intervention ; le cas échéant le/la remettre à la disposition de l'USEP ;</li>
                    <li>fournir mensuellement, une <span class="important">attestation de présence</span> au stage du/de la stagiaire cosigné par l'USEP ;</li>
    ...
    <table class="papsgouv-ecole-article-table">
        <tr>
            <td>
                ...
                <p>Outre les clauses générales figurant au présent contrat et que les Parties, par leur signature ci-dessous, acceptent sans restriction, l'USEP s'engage à verser mensuellement au/à la stagiaire, la <span class="important">prime de stage de {{ $primeWords }} ({{ $primeFormatted }}) F CFA</span>, par mobile money sur son numéro de téléphone disposant d'un compte <span class="important">TRESORPAY</span> identifié à son nom.</p>
            ...
            <td>
                ...
                <p>Dans le cadre de sa communication sur les programmes d'emploi, l'Agence Emploi Jeunes par le biais de l'USEP, prévoit faire des films témoignages des jeunes bénéficiaires.</p>
