@php
    ...
    $primeAmount = $stagiaire->isPrimeMirahEligible() ? 150000 : $primeData['amount'];
    $primeFormatted = number_format($primeAmount, 0, '', ' ');
    $primeWords = match ($primeAmount) {
        150000 => 'cent cinquante mille',
        default => $primeData['amount_in_words'],
    };
...
<style>
    ...
    .papsgouv-article-page:after {
        content: "";
        display: block;
        clear: both;
    }

    .papsgouv-article-column {
        float: left;
        width: 47%;
        vertical-align: top;
        padding: 0 8px;
    ...
    .papsgouv-article-gap {
        float: left;
        width: 2%;
        min-height: 1px;
    }

    .papsgouv-article-page h2 {
        font-size: 11.3pt;
        font-weight: 700;
        margin: 7px 0 4px 0;
    ...
    .papsgouv-article-page p {
        margin: 3px 0;
    }

    .papsgouv-article-page ul {
        margin: 4px 0;
        padding-left: 17px;
    }

    .papsgouv-article-page li {
        margin-bottom: 3px;
    }

    .papsgouv-article-page .important {
        font-weight: bold;
    }
</style>

<div class="papsgouv-article-page" style="page-break-before: always;">
    <p style="margin: 0 8px 6px;">
        Il a été convenu ce qui suit :
    </p>
    <div>
            <div class="papsgouv-article-column">
                ...
                <ul>
                    ...
                    <li>délivrer au/à la stagiaire, une <span class="important">attestation en fin de stage</span> cosignée par le PARTENAIRE et indiquant sa qualification, l'objet et la durée du stage.</li>
                </ul>
            </div><div class="papsgouv-article-gap"></div><div class="papsgouv-article-column">
...
<div class="papsgouv-article-page" style="page-break-before: always;">
 ...
 <p>L'affiliation à la Couverture Maladie Universelle (CMU) est obligatoire pour tout stagiaire. Le prélèvement pour les <strong>{{ $dureeEnMotsCMU }}</strong> de stage d'un montant de <strong>{{ $montantCMUWords }} ({{ $montantCMUFormatted }}) F CFA</strong> se fera en une fois sur la première prime de stage et la cotisation sera reversée à la Caisse Nationale d'Assurance Maladie (CNAM) pour le compte des stagiaires.</p>
            </div><div class="papsgouv-article-gap"></div><div class="papsgouv-article-column">
