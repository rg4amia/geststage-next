...
<body>
    {{-- Header Section --}}
    @include('stage.contrat.partials_budgetetat.header-ecole', [
        'agence' => $stagiaire->agence,
        'conseiller' => $stagiaire->conseiller->nom_prenoms
    ])

    {{-- Contract Parties Section --}}
    @include('stage.contrat.partials_budgetetat.contract-parties-ecole', [
        'stagiaire' => $stagiaire,
        'montant' => $montant,
        'fonction' => $fonction,
    ])
    ...
    {{-- Article Pages --}}
    @include('stage.contrat.partials_budgetetat.article-pages-ecole')

    {{-- Signature Section --}}
    @include('stage.contrat.partials_budgetetat.signatures-ecole', [
        'stagiaire' => $stagiaire,
        'fonction' => $fonction,
        'agence' => $stagiaire->agence,
    ])
