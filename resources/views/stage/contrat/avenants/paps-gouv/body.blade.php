...
<body>
    ...
    <div class="container">
        @include('stage.contrat.avenants.paps-gouv.header')
        <div class="text-align-left">
            ...
            <p class="paragraph-standard">
                <span class="span-12pt-107">La Société
                    ...
                    <strong>{{ $stagiaire->entreprise->ville ?? '....................................' }}</strong>,
                    Tél&nbsp;:
                    <strong>{{ $stagiaire->entreprise->contact ?? '....................................' }}</strong>,
                    représentée par
                    Monsieur/Madame&nbsp;<strong>{{ $stagiaire->entreprise->dg ?? '....................................' }}</strong>,
                    <strong>({{ $stagiaire->entreprise->fonction ?? '....................................' }})</strong></span>
            </p>
            ...
            {{-- LE STAGIAIRE Section --}}
            <p class="paragraph-standard">
                <strong><u><span class="span-12pt-107">LE
            ...
            <p class="paragraph-standard">
                <span class="span-12pt-107"> {{ strtolower($stagiaire->sexe) === 'homme' ? 'Monsieur' : 'Madame' }}
                    ...
                    @endif
                    , inscrit à l'Agence Emploi Jeunes sous le numéro
            ...
            <p class="paragraph-line-height-115">
                <span class="span-12pt-115">Dans le cadre du
                    programme de stage de qualification, <strong>l'Agence Emploi Jeunes</strong> et la Société
                    <strong>{{ $stagiaire->entreprise->libelle_entreprise ?? '...........................' }}</strong>
            ...
            <p class="paragraph-standard paragraph-standard-mt20">
                <span class="span-12pt-107">La Société
                    ...
                    <strong>{{ $stagiaire->nom_stagiaire . ' ' . $stagiaire->prenoms_stagiaire ?? '....................................' }}</strong>,
                    en qualité
                    d'<strong>{{ $stagiaire->intitule_poste_stage ?? '....................................' }}</strong>
                    à compter du
                    <strong>{{ isset($dateDebut) ? \Carbon\Carbon::parse($dateDebut)->isoFormat('DD/MM/Y') : '../../....' }}</strong>
                    au
                    <strong>{{ isset($dateFin) ? \Carbon\Carbon::parse($dateFin)->isoFormat('DD/MM/Y') : '../../....' }}</strong></span>
            </p>
            ...
            <ul class="ul-square">
                ...
                <li class="list-item-standard ">
                    <span class="span-12pt-115">Désigner
                        ...
                        rapport d'évaluation des aptitudes du stagiaire&nbsp;;</span>
                </li>
                <li class="list-item-standard">
                ...
                <li class="list-item-standard">
                    <span class="span-12pt-115">Prévenir l'Agence
                        Emploi Jeunes des insuffisances professionnelles du stagiaire, des fautes graves
                        ...
                        échéant la
                        remettre à la disposition de l'Agence Emploi Jeunes&nbsp;;</span>
                </li>
                <li class="list-item-standard">
