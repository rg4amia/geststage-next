...
<body>
    ...
    <div class="container">
        @include('stage.contrat.avenants.budget-aej.header')
        <div class="text-align-left">
            ...
            <p class="paragraph-line-height-115">
                ...
                <span class="span-12pt-115">structure créée par
                    ...
                    par
                    Monsieur {{ optional($agence)->chef_agence ?? '...........................' }}, Chef d'Agence
                    Régionale de
            ...
            <p class="paragraph-standard">
                <span class="span-12pt-107">La Société
                    ...
                    <strong>{{ $stagiaire->entreprise->secteur ?? '....................................' }}</strong> et
                    dont le siège social est situé à
                    <strong>{{ $stagiaire->entreprise->ville ?? '....................................' }}</strong>, N°
                    CNPS&nbsp;:
                    <strong>{{ $stagiaire->entreprise->num_cnps ?? '....................................' }}</strong>,
                    N° Compte Contribuable&nbsp;:
                    <strong>{{ $stagiaire->entreprise->num_compte_contribuable ?? '....................................' }}</strong>;
                    Tél&nbsp;:
                    <strong>{{ $stagiaire->entreprise->contact ?? '....................................' }}</strong>,
                    représentée par Monsieur/Madame
                    <strong>{{ $stagiaire->entreprise->dg ?? '....................................' }}</strong>
                    <strong>({{ $stagiaire->entreprise->fonction ?? '....................................' }})</strong>
                    dûment
                    habilité aux fins des présentes,</span>
            </p>
            ...
            {{-- LA STAGIAIRE Section --}}
            <p class="paragraph-standard">
                <strong><u><span class="span-12pt-107">LA
                            STAGIAIRE</span></u></strong>
            </p>

            <p class="paragraph-standard">
                <span class="span-12pt-107">{{ strtolower($stagiaire->sexe) === 'homme' ? 'Monsieur' : 'Madame' }}
                    ...
                    @endif
                    @if(isset($stagiaire->specialite) && $stagiaire->specialite)
                        option <strong>{{ $stagiaire->specialite }}</strong>
                    @else
                        option <strong>....................................</strong>
                    @endif
                    , inscrite à l'Agence Emploi Jeunes sous le numéro
            ...
            <p class="paragraph-line-height-115">
                <span class="span-12pt-115">Dans le cadre du
                    programme d'Aide à l'Embauche (PAE), <strong>l'Agence Emploi Jeunes</strong> et
                    <strong>{{ $stagiaire->entreprise->libelle_entreprise ?? '...........................' }}</strong>
                    ont conclu un contrat de stage d'une durée de <strong>Six (06) mois</strong> avec
                    {{ strtolower($stagiaire->sexe) === 'homme' ? 'Monsieur' : 'Madame' }}
                    <strong>{{ $stagiaire->nom_stagiaire . ' ' . $stagiaire->prenoms_stagiaire ?? '...........................' }}</strong>
            ...
            <ul class="ul-square">
                ...
                <li class="list-item-standard ">
                    <span class="span-12pt-115">désigner
                        Monsieur/Madame
                        <strong>{{ $stagiaire->nom_encadreur ?? '...........................' }}</strong><strong>,
                        </strong><strong>{{ $stagiaire->fonction_encadreur ?? 'Gérant' }}</strong> comme Encadreur
                        ...
                        rapport d'évaluation des aptitudes de la stagiaire&nbsp;;</span>
                </li>
                <li class="list-item-standard">
                ...
                <li class="list-item-standard">
                    <span class="span-12pt-115">Prévenir l'Agence
                        Emploi Jeunes des insuffisances professionnelles de la stagiaire, des fautes graves
                        ...
                        échéant la remettre à la disposition de l'Agence Emploi Jeunes&nbsp;;</span>
                </li>
                <li class="list-item-standard">
                ...
                <li class="list-item-standard">
                    <span class="span-12pt-115">Octroyer
                        mensuellement à la stagiaire, une prime de stage d'un montant minimum de
                        <strong>{{ isset($prime) ? number_format($prime, 0, ',', ' ') : '....................................' }}
                            F CFA</strong>&nbsp;;</span>
                </li>
                <li class="list-item-standard">
