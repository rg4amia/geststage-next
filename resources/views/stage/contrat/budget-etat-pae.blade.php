...
<body>
    {{-- Header Section --}}
    @include('stage.contrat.partials_budgetetat.header', [
        'agence' => $stagiaire->agence,
        'conseiller' => $stagiaire->conseiller->nom_prenoms,
    ])

    {{-- Contract Parties Section --}}
    @include('stage.contrat.partials_budgetetat.contract-parties', [
        'stagiaire' => $stagiaire,
        'montant' => $montant,
        'fonction' => $fonction,
    ])
    ...
    {{-- Article Pages --}}
    @include('stage.contrat.partials_budgetetat.article-pages', compact('stagiaire'))

    {{-- Signature Section --}}
    @include('stage.contrat.partials_budgetetat.signatures', [
        'stagiaire' => $stagiaire,
        'fonction' => $fonction,
        'agence' => $stagiaire->agence,
    ])
